...
# Define Streamlit inputs corresponding to Gradio inputs
age = st.number_input("Age")
business_travel = st.selectbox("BusinessTravel", ["Travel_Rarely", "Travel_Frequently", "Non-Travel"])
daily_rate = st.number_input("DailyRate")
department = st.selectbox("Department", ["Sales", "Research & Development", "Human Resources"])
distance_from_home = st.number_input("DistanceFromHome")
...
monthly_income = st.number_input("MonthlyIncome")
no_of_companies_worked = st.number_input("No of Companies Worked")
overtime = st.selectbox("OverTime", ["Yes", "No"])
last_percent_salary_hike = st.number_input("Last Percent Salary Hike")
last_performance_rating = st.selectbox("Last Performance Rating", [1, 2, 3])
...
training_times_last_year = st.number_input("TrainingTimesLastYear")
total_working_years = st.number_input("TotalWorkingYears")
work_life_balance = st.selectbox("Work-Life Balance", [1, 2, 3, 4])
years_at_company = st.number_input("Years At Company")
years_in_current_role = st.number_input("Years In CurrentRole")
...
if st.button("Predict"):
    print()
    prediction = predict(age , business_travel , daily_rate , department , distance_from_home , education , education_field , environment_satisfaction , gender , job_involvement , job_level , job_role , job_satisfaction , marital_status , monthly_income , no_of_companies_worked , overtime , last_percent_salary_hike , last_performance_rating , relationship_satisfaction , stock_option_level , training_times_last_year , total_working_years , work_life_balance , years_at_company , years_in_current_role , years_since_last_promotion , years_with_current_manager)
...
#     gr.components.Dropdown(choices=[1,2,3,4,5], label="Education"),
...
#     gr.components.Dropdown(choices=[1,2,3,4], label="Work-Life Balance"),
